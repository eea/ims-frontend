...
## Sync w/ Github template

Synchronize git templates generated by GitHub as if they were forks.

In order to synchronize a child instance of Github [eea/volto-starter-kit template](https://github.com/eea/volto-starter-kit) you can use [git-upstream-template](https://github.com/rioam2/git-upstream-template) like:
